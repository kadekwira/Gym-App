...
<div class="main-content">
  <section class="section">
    ...
    <div class="row">
      <div class="col-12 ">
        <div class="card">
          <form method="post" action="{{route('data-trial.store')}}">
            @csrf
            <div class="card-header">
              <h4>Add Data Trial</h4>
            </div>
            <div class="card-body row">
              ...
              <div class="col-12">
                <div class="form-group">
                  ...
                  <input type="date" class="form-control" name="date_trial" id="date_trial">
                </div>
              </div>
              <div class="col-12">
                <div class="form-group">
                  <label>Start Trial</label>
                  <select class="form-control" name="start_trial" id="start_trial">
              ...
              <div class="col-12">
                <div class="form-group">
                  ...
                  <input type="time" class="form-control" name="end_trial" readonly id="end_trial">
                </div>
              </div>
            </div>
