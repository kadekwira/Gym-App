...
<div class="main-content">
    <section class="section">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <form action="{{ route('updateInformation', $informationgym->id) }}" method="POST"
                        enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="card-header">
                            <h4>Update Information Gym</h4>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required="" name="gym_location"
                                        value="{{ $informationgym->gym_location }}">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control" name="open_operational"
                                        id="open_operational" value="{{ $informationgym->open_operational }}">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control" name="close_operational"
                                        id="close_operational" value="{{ $informationgym->close_operational }}">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="int" class="form-control" name="operational_time" readonly
                                        value="{{ $informationgym->operational_time }}">
                                </div>
                            </div>
                        </div>
